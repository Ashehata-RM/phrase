...
app.config['SQLALCHEMY_DATABASE_URI'] = 'postgresql+psycopg2://readonly:readonlypassword@host:5432/mydb'
...
def hello_world():
    ...
    if connection:
        return "Connected to database mydb"
    else:
        return "Not connected to database mydb"
